(function($) {
        ...
        var place = {
            ...
            toggleMarker: function() {
                ...
                if (this.isMarked) {
                    ...
                    dispEvent(this.group, 'schemePlaceSelect', {place: place});
                } else {
            ...
            onPgroupsClick: function(ev) {
                $('#' + this.pgroups + ' p').on('click', function() {
    ...
    var Ticket = function(place) {
        var ticket = {
            ...
            onDelButtonClick: function(ev){
                ...
                dispEvent(this.place.group, 'schemeTicketDelete', {ticket: ticket});
            }
        };
    ...
    var Scheme = {
        ...
        onSchemePan: function(pos) {
            Scheme.setSchemeDistance(pos);
            Scheme.setOutsize(pos);
            if (Scheme.minimapIsShown) Scheme.moveHelper(Scheme.schemeDistance);
        },
